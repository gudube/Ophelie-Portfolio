...
export class PagePeinturesComponent implements OnInit {
	...
	private drawings: PictureModel[] = [
		...
		{ fileName: 'peintures/p0.jpg', title: 'GÉOMÉTRIE DE LA NEUTRALITÉ ILLUSOIRE', subtitle: '2014, acrylique sur toile, 25 x 20cm', description: 'description', subImages: ['peintures/p0.jpg'] },
		{ fileName: 'dessins/d8.jpg', title: 'POUR NE PLUS LES ENTENDRE', subtitle: '2021, crayon à mine sur papier à dessin, 15 x 23cm', description: 'description', subImages: ['dessins/d8.jpg'] },
		{ fileName: 'dessins/d7.jpg', title: 'CES CRIS QUE L\'ON SE REFUSE', subtitle: '2021, crayon à mine sur papier à dessin, 15 x 23cm', description: 'description', subImages: ['dessins/d7.jpg'] },
		{ fileName: 'dessins/d6.jpg', title: 'EN MORCEAUX', subtitle: '2021, crayon à mine sur papier à dessin, 14 x 21cm', description: 'description', subImages: ['dessins/d6.jpg'] },
		{ fileName: 'dessins/d5.jpg', title: 'DES TOURNESOLS PARTICULIERS', subtitle: '2021, crayon à mine sur papier à dessin, 14 x 21cm', description: 'description', subImages: ['dessins/d5.jpg'] },
		{ fileName: 'dessins/d4.jpg', title: 'COEUR LIQUIDE', subtitle: '2021, crayon à mine sur papier à dessin, 14 x 21cm', description: 'description', subImages: ['dessins/d4.jpg'] },
		{ fileName: 'dessins/d3.jpg', title: 'QUAND LES PLEURS SONT ACIDES', subtitle: '2021, crayon à mine sur papier à dessin, 14 x 21cm', description: 'description', subImages: ['dessins/d3.jpg'] },
		{ fileName: 'dessins/d2.jpg', title: 'REALITÉ ALTERNATIVE', subtitle: '2021, crayon à mine sur papier à dessin, 14 x 10.5cm', description: 'description', subImages: ['dessins/d2.jpg'] },
		{ fileName: 'dessins/d1.jpg', title: 'CHHHUT', subtitle: '2021, crayon à mine sur papier à dessin, 11 x 14cm', description: 'description', subImages: ['dessins/d1.jpg'] },
		{ fileName: 'dessins/d0.jpg', title: 'CROQUIS', subtitle: '2021, crayon à mine sur papier à dessin, 21.5 x 28cm', description: 'description', subImages: ['dessins/d0.jpg'] },
		{ fileName: 'sculptures/s1.jpg', title: 'titre 8', subtitle: 'sous-titre 8', description: 'description', subImages: ['sculptures/s1.jpg'] },
		{ fileName: 'sculptures/s2.jpg', title: 'titre 8', subtitle: 'sous-titre 8', description: 'description', subImages: ['sculptures/s2.jpg'] },
		{ fileName: 'sculptures/s3.jpg', title: 'titre 8', subtitle: 'sous-titre 8', description: 'description', subImages: ['sculptures/s3.jpg'] },
		{ fileName: 'sculptures/s4.jpg', title: 'titre 8', subtitle: 'sous-titre 8', description: 'description', subImages: ['sculptures/s4.jpg'] },
	];
